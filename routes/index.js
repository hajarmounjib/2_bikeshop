...
const stripe = require('stripe')('sk_test_51I9pATEbO5AGWXDb5cJU1RQhslJ3VzRYUZDjAfKO4DhdjSvPHBzxz8YUvUsgVSR94g8V1q5SJiqnRun0NHOsF1Dw00euHnpE5i');
...
for(var i=0;i< req.session.dataCardBike.length;i++){
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    line_items:newTableau,
    mode: "payment",
    success_url: 'http://127.0.0.1:3000/confirmation',
...
router.get('/confirmation', function(req, res, next) {  
  ...
  res.render('confirmation', {dataBike:dataBike});
});
